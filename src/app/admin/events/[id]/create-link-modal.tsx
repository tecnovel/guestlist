...
function CreateLinkForm({ eventId, promoters, onSuccess }: { eventId: string, promoters: User[], onSuccess: () => void }) {
    const createLinkWithId = createLink.bind(null, eventId);
    ...
    return (
        <form action={dispatch} className="space-y-4">
            ...
            <div>
                <Select label="Promoter (Optional)" name="promoterId" id="promoterId">
...
export function CreateLinkModal({ eventId, promoters }: { eventId: string, promoters: User[] }) {
                ...
                <div className="relative inline-block align-bottom bg-gray-900 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 border border-gray-800">
                    ...
                    <div className="sm:flex sm:items-start">
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div className="mt-2">
                                <CreateLinkForm key={version} eventId={eventId} promoters={promoters} onSuccess={() => setIsOpen(false)} />
                            </div>
                        </div>
                    </div>
                </div>
